...
// I will just replace the whole file to make sure it's clean and has no demo user stuff.
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center border border-slate-100">
        ...
        <p className="text-slate-500 mb-6">আপনার হেলথকেয়ার ডিজিটাল সঙ্গী। গুগল একাউন্টের মাধ্যমে লগইন করুন।</p>
        ...
        {error && (
          <div className="mb-6 p-4 bg-rose-50 text-rose-700 text-sm font-medium rounded-2xl border border-rose-100 text-left">
            ...
            <div className="text-xs space-y-2 border-t border-rose-200/80 pt-3 text-slate-700">
              <p className="font-semibold text-rose-800">গুগল লগইন সমস্যার সমাধান (২টি পদক্ষেপ):</p>
...
fs.writeFileSync('src/components/Login.tsx', cleanCode);
